...
using System.IO;
using BlurHashSharp.ImageSharp;
...
namespace Jellyfin.Drawing.ImageSharp;

/// <summary>
/// Image encoder that uses <see cref="ImageSharp"/> to manipulate images.
/// </summary>
public class ImageSharpEncoder : IImageEncoder
{
    ...
    private readonly ILogger<ImageSharpEncoder> _logger;
    private readonly IApplicationPaths _appPaths;

    /// <summary>
    /// Initializes a new instance of the <see cref="ImageSharpEncoder"/> class.
    /// </summary>
    /// <param name="logger">The application logger.</param>
    /// <param name="appPaths">The application paths.</param>
    public ImageSharpEncoder(ILogger<ImageSharp> logger, IApplicationPaths appPaths)
    {
        _logger = logger;
        _appPaths = appPaths;
    }
    ...
    public static SKEncodedImageFormat GetImageFormat(ImageFormat selectedFormat)
    {
        ...
        {
            ImageFormat.Bmp => BlurHashSharp.ImageSharp.Formats.Bmp,
