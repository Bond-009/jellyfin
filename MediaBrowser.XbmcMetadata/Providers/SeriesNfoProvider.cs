...
namespace MediaBrowser.XbmcMetadata.Providers
{
    ...
    public class SeriesNfoProvider : BaseNfoProvider<Series>
    {
        ...
        {
            new SeriesNfoParser(_logger, _config, _providerManager, _userManager, _userDataManager, FileSystem).Fetch(result, path, cancellationToken);
        }

        /// <inheritdoc />
        protected override FileSystemMetadata? GetXmlFile(ItemInfo info)
            => FileSystem.GetFileInfo(Path.Combine(info.Path, "tvshow.nfo"));
    }
}
